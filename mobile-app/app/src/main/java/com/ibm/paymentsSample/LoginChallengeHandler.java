...
public class LoginChallengeHandler extends SecurityCheckChallengeHandler {
    ...
    public static LoginChallengeHandler createAndRegister(){
        LoginChallengeHandler challengeHandler = new LoginChallengeHandler();
